  ...
  public: {
    Tables: {
      ...
      larinova_consultations: {
        ...
        Relationships: [
          {
            foreignKeyName: "larinova_consultations_doctor_id_fkey";
            columns: ["doctor_id"];
            isOneToOne: false;
            referencedRelation: "larinova_doctors";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "larinova_consultations_patient_id_fkey";
            columns: ["patient_id"];
            isOneToOne: false;
            referencedRelation: "larinova_patients";
            referencedColumns: ["id"];
          },
        ];
      };
      ...
      larinova_health_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "larinova_health_records_doctor_id_fkey";
            columns: ["doctor_id"];
            isOneToOne: false;
            referencedRelation: "larinova_doctors";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "larinova_health_records_patient_id_fkey";
            columns: ["patient_id"];
            isOneToOne: false;
            referencedRelation: "larinova_patients";
            referencedColumns: ["id"];
      ...
      larinova_insurance: {
        ...
        Relationships: [
          {
            foreignKeyName: "larinova_insurance_patient_id_fkey";
            columns: ["patient_id"];
            isOneToOne: false;
            referencedRelation: "larinova_patients";
            referencedColumns: ["id"];
      ...
      larinova_patients: {
        ...
        Relationships: [
          {
            foreignKeyName: "larinova_patients_created_by_doctor_id_fkey";
      ...
      larinova_prescription_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "larinova_prescription_items_medicine_id_fkey";
            columns: ["medicine_id"];
            isOneToOne: false;
            referencedRelation: "larinova_medicines";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "larinova_prescription_items_prescription_id_fkey";
            columns: ["prescription_id"];
            isOneToOne: false;
            referencedRelation: "larinova_prescriptions";
            referencedColumns: ["id"];
          },
        ];
      };
      larinova_prescriptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "larinova_prescriptions_consultation_id_fkey";
            columns: ["consultation_id"];
            isOneToOne: false;
            referencedRelation: "larinova_consultations";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "larinova_prescriptions_doctor_id_fkey";
            columns: ["doctor_id"];
            isOneToOne: false;
            referencedRelation: "larinova_doctors";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "larinova_prescriptions_patient_id_fkey";
            columns: ["patient_id"];
            isOneToOne: false;
            referencedRelation: "larinova_patients";
            referencedColumns: ["id"];
      ...
      larinova_transcripts: {
        ...
        Relationships: [
          {
            foreignKeyName: "larinova_transcripts_consultation_id_fkey";
            columns: ["consultation_id"];
            isOneToOne: false;
            referencedRelation: "larinova_consultations";
            referencedColumns: ["id"];
      ...
      salvation_conversations: {
        ...
        Relationships: [
          {
            foreignKeyName: "salvation_conversations_application_id_fkey";
            columns: ["application_id"];
            isOneToOne: false;
            referencedRelation: "salvation_project_applications";
            referencedColumns: ["id"];
          },
        ];
      };
      salvation_ipfs_metadata: {
        Row: {
          cid: string;
          content: string;
      ...
      salvation_project_applications: {
        Row: {
        ...
        Relationships: [
          {
            foreignKeyName: "salvation_project_applications_wallet_address_fkey";
            columns: ["wallet_address"];
            isOneToOne: false;
            referencedRelation: "salvation_businesses";
